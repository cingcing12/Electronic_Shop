...
<title>Electronic_Shop - Login</title>
 <!-- Bootstrap CSS -->
...
<div class="login-wrapper">
  ...
  <div class="login-card p-4 p-md-5 rounded-4 shadow-lg">
    <h2 class="text-center fw-bold mb-4 text-gradient">Welcome Back</h2>
    ...
    <form method="post" novalidate>
      ...
      <div class="d-grid mb-3">
        <button type="submit" class="btn btn-glass btn-lg rounded-pill shadow-sm">Login</button>
      </div>
